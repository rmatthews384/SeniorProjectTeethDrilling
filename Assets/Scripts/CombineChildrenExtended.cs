...
public class CombineChildrenExtended : MonoBehaviour {
	...
	public bool generateTriangleStrips = true, combineOnStart = true, destroyAfterOptimized = true, castShadow = true, receiveShadow = true, keepLayer = true, addMeshCollider = false;
